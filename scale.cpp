/* ///////////////////////////////
scale2pitch.cpp
Author : 竹田大将(Hiromasa Takeda)
Compile: g++ -o scale scale.cpp -std=c++11
Usage  : scale <scale>
/////////////////////////////// */
#include <iostream>
...
float scale2pitch(const char* scale) {
	unordered_map<string,float> str2freq = {
	...
	return str2freq[scale];
}

int main(int argc, char *argv[])
{
	cout << scale2pitch(argv[1]) << '\n';
